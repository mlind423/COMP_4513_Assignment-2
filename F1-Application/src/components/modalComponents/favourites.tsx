        ...
        return (
            <div className="flex flex-col modal-box max-w-none w-full px-3 py-3">
                ...
                <div className="flex flex-col lg:flex-row">
                    <div className="text-nowrap overflow-auto grid flex-grow w-auto max-h-60 card bg-base-300 rounded-box px-3 py-3 place-items-center">
                    ...
                    <div className="text-nowrap w-auto max-h-60 grid flex-grow card bg-base-300 rounded-box px-3 py-3 place-items-center ">
                    ...
                    <div className="text-nowrap w-auto max-h-60 grid flex-grow card bg-base-300 rounded-box place-content-start px-3 py-3 place-items-center">
