...
export default function Modal(props) {
    ...
    return (
        <div>
            ...
            <dialog id={props.data.drivers.driverRef} className="modal w-auto">
                <div className="modal-box px-10 py-10 w-4/5 overflow-hidden">
                    <form method="dialog">
                        <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                    </form>
                    <ConstructorContent type={props.type}/>
                    <DriverContent type={props.type} surname={props.data.drivers.surname} forename={props.data.drivers.forename}/> 
